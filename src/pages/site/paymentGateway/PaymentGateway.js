        ...
        <div className="parent">
            <section className="first-section section">
                <CardText title1={"Get paid instantly"}
                    title2={"with Payment Links"} para={`Share payment link via an email, SMS, messenger, chatbot etc. and
                ...
                <div className="group-divs">
                    <div className="div1">
                        <div>
                            ...
                            <p>
                                ...
                                Credit & Debit cards, EMIs (
                                Credit/Debit Cards & Cardless),
                                UPI and 8 mobile wallets, Anaizan
                                Payprovides the most extensive
                        ...
                        <div >
                            ...
                            <p>
                                An easy to integrate Checkout
                                with cards saved across
                                businesses so that your
                        ...
                        <div>
                            ...
                            <p>
                                Get reports and detailed statistics
                                on payments, settlements,
                                refunds and much more for you to
                    ...
                    <div className="div2">
                        ...
                        <div>
                            ...
                            <p>
                                PCI DSS Level 1 compliant along with frequent third party
                                audits and a dedicated internal security team to make sure
            ...
            <section className="section-four-pgat section">
                ...
                <div className="div-s-pgat">
                    <div className="div-text">
                        ...
                        <p>
                            Give your customers a smooth payment experience by
                            helping them enter and reuse their information, as well as
                            detect errors in real time.
                        </p>
                        <div className="list">
                            {list.map((list, index) => {
                                return <p> <img src={check} /> {list} </p>
                            })}
                        </div>
                    </div>
                    <img src={screen1} />
            ...
            <section className="section-six-pgat section">
                ...
                <div className="div-text">
                    ...
                    <p>
                        ...
                        international customers by allowing them to pay in their local currency.
                    </p>
            ...
            <section className="section-six-pgat seven section">
                <div className="div-text">
                    ...
                    <p>
                        ...
                        business decisions. View important stats and generate
                        customizable settlement and reconciliation reports.
                    </p>
                    <h6> Easy to Use </h6>
                    <p>
                        e understand that when it comes to managing payments, speed
                        and ease of use is what matters at the end of the day. We've spent
                        endless hours to make it a great experience for you.
                    </p>
                    <button>Sihn Up Now</button>
                </div>
                <img src={screen4} />
            ...
            <section className="section-five-plink section ">
                ...
                <p className="text">
                    With no setup or maintenance fees and one of the lowest transaction charges
                    in the industry, pay only when you get paid!
                </p>
