		...
		<div className="parent">
			...
			<section className="section-three-plink section">
				<div className="div-b-s3">
					<div className="d1">
						...
						<p>
							Anaizan Pay Payment Links directly integrates into your ecosystem
							giving the best experience for your business model.
						</p>
						<p>
							No matter how specific your use case, we can help. Sign Up to get
							started.
						</p>
			...
			<section className="section-four-plink section">
				<div className="div1-s4-plink">
					<h5>Start Toda</h5>
					<h2 className="section-title">
						Now create and track Payment Links on the all new Anaizan Pay Mobile
						App
					</h2>
					<p>reate unlimited links for free from anywhere, anytime.</p>
					<p>
						{' '}
						<FaCheckSquare /> Create and share payment links instantly{' '}
					</p>
					<p>
						{' '}
						<FaCheckSquare /> Track payments on the go{' '}
					</p>
					<p>
						{' '}
						<FaCheckSquare /> Issue refunds with a single click{' '}
					</p>
					<p>
						{' '}
						<FaCheckSquare /> Hassle- free onboarding{' '}
					</p>
			...
			<section className="section-five-plink section ">
				<h2 className="section-title">No Extra Charges Applicable</h2>
				<p className="text">
					Create and customise your payment links for free, and get charged only
