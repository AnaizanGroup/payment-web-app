...
const PaymentScan: React.FC = () => {
	return (
		<div className="parent">
			<section className="first-section section">
				<CardText
					title1={'A Fast & Easy Way '}
					title2={'to Pay Anywhere'}
			...
			<section className="section-three-pscan section">
				<h2 className="section-title">Accept Payment Via Payments Multi QR</h2>
			...
			<section className="section-four-pscan section">
				<h2 className="section-title">All-in-One QR</h2>
				<p>Collect QR code payments using UPI QR or Bharat QR</p>
				<div className="div-b-s3">
					<div className="d1">
						<div className="cases">Customized to your brand</div>
						<div className="cases">Track payments seamlessly</div>
						<div className="cases">Generate multiple QRs</div>
					</div>
					<img src={scan_m} />
				</div>
			</section>
			...
			<section className="section-five-pscan section">
				<h2 className="section-title">Make payment easy for your customers</h2>
				<p>
					{' '}
					Choose from multiple features and get a QR code that suits your
					business need{' '}
				</p>
				<img src={screen} />
			</section>
			...
			<section className="section-six-pscan section">
				...
				<p className="subtitle">
					With no setup or maintenance fees, Anaizan makes payments simpler for
					all businesses. Pay only when you get paid!
				</p>
				<div className="pricing-div">
					...
					<div className="pricing-type">
						<h5>
							{' '}
							<img src={f} /> UPI Payment
						</h5>
						<h5>
							{' '}
							<img src={c} /> UPI Credit & Debit Card
						</h5>
					</div>
					<div className="tarif">
						<div className="t1">
							<h3>1%</h3>
							<p>Razorpay Platform fees | Applicable on each transaction</p>
						</div>
					...
					<div className="btn-sign">
						...
						<p>
							Sign up now to learn more about the Razorpay payments suite and
							explore our powerful dashboard.
						</p>
					</div>
					<p className="last-p">
						{' '}
						* GST Applicable. This pricing is not applicable on Razorpay
						Checkout.{' '}
					</p>
				</div>
			</section>
