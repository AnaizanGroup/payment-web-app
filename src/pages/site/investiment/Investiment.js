    ...
    return (
        <div className="parent">
            <section className="first-section section">
                <CardText title1={"Smart investments"}
                    title2={"for the future"} para={` Curabitur dictum euismod risus, eget eleifend nulla malesuada ut.
            ...
            <section className="section-two-invest section">
                ...
                <div className="div-card-s2-invest">
                    {offers && offers.map((list, index) => {
                        return <div className="card-s2-invest" key={index}>
                            <img src={list.img} />
                            <h4> {list.title} </h4>
                            <p> {list.para} </p>
                        </div>
            ...
            <section className="section-three-invest section">
                <div className="parent-s3-invest">
                    <img src={image_s3} />
                    <CardText2 title={`Investissez dans l'or à
                                        partir de 1k $ seulement
                                        `}
                        para={`ed ut perspiciatis unde omnis iste natus error sit voluptatem
                                accusantium doloremque laudantium, totam rem aperiam.`}
                        opt1={"Small Capital"} opt2={"Easy Transaction Access"}
                        opt3={"Attractive Returns"} opt4={"Social Impact"}
                        opt5={"Security"}
                    />
                </div>
            </section>
            ...
            <section className="section-four-invest section">
                <div className="card-s4-invest">
                    <img src={ble} />
                    <h2 className="section-title">investments in
                        stocks
                    </h2>
            ...
            <section className="section-five-invest section">
                ...
                <div className="group-card-s5">
                    ...
                    <div className="groups-card-s5-inv">
                        {bestOffer && bestOffer.map((list, index) => {
                            return <div className="card-s5-inv" key={index}>
                                <h4> {list.title} </h4>
                                <p> {list.text} </p>
                            </div>
                        })}
                    ...
                    <div className="card-text-s6-inv">
                        ...
                        <div className="groups-text">
                            {freelance_talent && freelance_talent.map((list, index) => {
                                return <div className="card-s6-inv" key={index}>
                                    <img src={list.img} />
                                    <div>
                                        <h5> {list.title} </h5>
                                        <p> {list.text} </p>
