...
const InvestimentStart: React.FC = () => {
	const offering = [
		{
			img: img1,
			company: 'Anaizan',
	...
	return (
		<div className="parent">
			<section className="first-section section">
				<CardText
					title1={'Startups investments'}
					title2={'Main Street businesses'}
			...
			<section className="section-two-start section">
				...
				<div className="groups-card-s2-starts">
					{offering?.map((list, index) => {
						return (
							<div className="card-s2-starts" key={index}>
								<img src={list.img} />
								<div className="infos">
									<h3> {list.company} </h3>
									<p> {list.adresse} </p>
				...
				<button className="view-all button-hover-red">
					{' '}
					View all project{' '}
				</button>
			</section>
			<SectionJob />
			<Section3
				title={'Looking to raise capital for your growing business ?'}
				para={undefined}
			/>
			<SectionShare />
			<Faq />
