...
get paid immediately`,
	...
	return (
		<div className="parent">
			...
			<Section2
				title={'Buy and secure gold with the tap of a finger'}
			...
			<SectionDownload />
			<Section3
				title={'Diversify your portfolio with physical investments'}
				para={undefined}
			/>
			<section className="section-five-gold section">
				<div className="top-block">
					<div className="groups-card-s5-gold">
						{filiale?.map((list, index) => {
							let item;
							if (index < 3) {
								item = (
									<div className="card-s5-gold" key={index}>
										<div className="icon">
											<img src={list.icon} />
										</div>
					...
					<div className="right-content">
						...
						<h2 className="section-title">Why Invest in Physicaly Gold</h2>
						<p>
							Investing in a gold IRA is a great way to add diversification to
							your retirement portfolio for a few key reasons. First, when
							markets are down and paper assets are losing value, gold
							investments will typically increase in value. However, when
							markets are up, gold still tends to increase in value. In fact,
							gold is up more than iÂÂÐ over the last pÂ years. In addition,
							unlike stocks, bonds, and foreign currencies, gold is a physical
							asset that you can own. So when you are buying physical gold with
							an IRA youÄre saving for retirement with assets you can hold.
						</p>
					</div>
				</div>
